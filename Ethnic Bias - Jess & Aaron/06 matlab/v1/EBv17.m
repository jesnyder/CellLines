...
ylabel({'Number of Cell Lines'}); ylim([.5 40]); set(gca,'YTick',[0:5:50]); 
...
ylabel({'Number of Publications'}); ylim([0 3E4]); set(gca,'YTick',[1E0 5E0 1E1 5E1 1E2 5E2 1E3 5E3 1E4 5E4 1E5 5E5 1E6]); set(gca,'yscale','log');
